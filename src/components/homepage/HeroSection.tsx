...
export const HeroSection = ({
  ...
  return <>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-180px)] sm:min-h-[calc(100vh-240px)] text-center px-4" style={{
      zIndex: 1
    }}>
        <div className="relative max-w-2xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex justify-center mb-3 sm:mb-4">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 rounded-md bg-primary-hover/10 border border-primary-hover/20">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-hover flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
              </svg>
              <span className="text-[10px] sm:text-xs font-medium text-primary-hover">Fast. Private. Simple.</span>
            </div>
          </div>
