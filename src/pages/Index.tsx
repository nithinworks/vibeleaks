        ...
        <div className="container mx-auto px-8 py-4">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between gap-4">
              <ThemeToggle />
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-hover/10 border border-primary-hover/20">
                <svg 
                  viewBox="0 0 24 24" 
                ...
                <span className="text-xs font-medium text-primary-hover">Best on Chrome</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          {viewMode === "input" && (
            <>
              ...
              <div className="fixed inset-0 pointer-events-none overflow-hidden dark:hidden -z-10">
                <FallingPattern 
                  color="hsl(12 78% 55% / 0.25)"
              ...
              <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-240px)] text-center">
                {/* Content */}
