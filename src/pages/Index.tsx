        ...
        <div className="max-w-7xl mx-auto">
          {viewMode === "input" && (
            <>
              ...
              <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-180px)] sm:min-h-[calc(100vh-240px)] text-center px-4" style={{ zIndex: 1 }}>
                ...
                <div className="flex flex-col items-center gap-4 pt-4">
                  <div className="relative">
                    ...
                    {/* Hand-drawn arrow with handwritten text */}
                    <div className="absolute -right-32 top-1/2 -translate-y-1/2 hidden xl:block pointer-events-none">
                      <svg 
                        width="120" 
                        height="80" 
                        viewBox="0 0 120 80" 
                      ...
                      <p className="font-handwritten text-primary-hover text-sm -mt-2 whitespace-nowrap">
                        select project folder from here
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Features Section */}
              <div className="relative mt-20 pb-16" style={{ zIndex: 1 }}>
